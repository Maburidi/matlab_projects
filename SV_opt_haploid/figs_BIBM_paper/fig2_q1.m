...
close all
figure(1)
plot(Alp,acc_3d,"LineWidth",1,"Color","blue");hold on
plot(Alp,acc_2d,"LineWidth",1,"Color","red"); hold on 
scatter(Alp,acc_3d,'filled',"blue"); hold on
scatter(Alp,acc_2d,'filled',"red");
ylabel('$AUC_{pr}$','FontSize',30,Interpreter="latex");
xlabel('$\lambda_{c}$','FontSize',30, Interpreter="latex");
...
figure(2)
subplot(3,1,1)
plot(Alp,acc_3d_c,"LineWidth",1,"Color","blue");hold on
plot(Alp,acc_2d_c,"LineWidth",1,"Color","red"); hold on 
scatter(Alp,acc_3d_c,'filled',"blue"); hold on
scatter(Alp,acc_2d_c,'filled',"red");
ylabel('$AUC_{pr}$','FontSize',20,Interpreter="latex");
xlabel('$\lambda_{p}$','FontSize',20, Interpreter="latex");
legend("3D projections",'2D projections',"Location","best")
title("Child Signal")
ylim([0.4 1.001])

subplot(3,1,2)
plot(Alp,acc_3d_p,"LineWidth",1,"Color","blue");hold on
plot(Alp,acc_2d_p,"LineWidth",1,"Color","red"); hold on 
scatter(Alp,acc_3d_p,'filled',"blue"); hold on
scatter(Alp,acc_2d_p,'filled',"red");
ylabel('$AUC_{pr}$','FontSize',20,Interpreter="latex");
xlabel('$\lambda_{p}$','FontSize',20, Interpreter="latex");
legend("3D projections",'2D projections',"Location","best")
title("Parent Signal")
...
subplot(3,1,3)
plot(Alp,acc_3d_gp,"LineWidth",1,"Color","blue");hold on
plot(Alp,acc_2d_gp,"LineWidth",1,"Color","red"); hold on 
scatter(Alp,acc_3d_gp,'filled',"blue"); hold on
scatter(Alp,acc_2d_gp,'filled',"red");
ylabel('$AUC_{pr}$','FontSize',20,Interpreter="latex");
xlabel('$\lambda_{p}$','FontSize',20, Interpreter="latex");
legend("3D projections",'2D projections',"Location","best")
