...
p = linspace(0.05,1,30);

for z =1:length(p)
disp('=====================')
disp(p(z))

k_p = round(p(z)*k_gp);  % number of SV in P
k_c = round(p(z)^2*k_gp); % number of SV in C
...
[fhatSPIRAL_1gp1p1c, iterationsSPIRAL, objectiveSPIRAL,...
 ...
 [fhatSPIRAL_1gp1p1c_2, iterationsSPIRAL_2, objectiveSPIRAL_2,...
            reconerrorSPIRAL_2, cputimeSPIRAL_2] ...
            = SPIRALTAP_1GP1P1C_Hap_2d(y,A,reg,...
            'maxiter',maxiter,...
            'Initialization',finit,...
            'AT',AT,...
            'miniter',5,...
  ...
  fhatSPIRAL_c_2d= fhatSPIRAL_1gp1p1c_2(1:n);
  fhatSPIRAL_p_2d = fhatSPIRAL_1gp1p1c_2(n+1:2*n);
  fhatSPIRAL_gp_2d = fhatSPIRAL_1gp1p1c_2(2*n+1:3*n);
...
f_true = [f_c ; f_p; f_gp];  
f_spiral_3d = [fhatSPIRAL_c;fhatSPIRAL_p;fhatSPIRAL_gp];  
f_spiral_2d = [fhatSPIRAL_c_2d;fhatSPIRAL_p_2d;fhatSPIRAL_gp_2d];   

[X1,Y1] = perfcurve(f_true,f_spiral_3d,'1','XCrit', 'tpr', 'YCrit', 'prec');
[X2,Y2] = perfcurve(f_true,f_spiral_2d,'1','XCrit', 'tpr', 'YCrit', 'prec');
Y1(1)=1;
Y2(1)=1;
Y1(end)=0;
Y2(end)=0;
...
acc_3d(z) = Area_recall_3d;%model_acurracy(f_true,f_spiral);             % accuracy 
acc_2d(z) = Area_recall_2d;%model_acurracy(f_true,f_spiral);             % accuracy 
%------------------

f_c_true = [f_c]; %; f_p; f_gp];  
f_c_spiral_3d = [fhatSPIRAL_c];%fhatSPIRAL_p;fhatSPIRAL_gp];  
f_c_spiral_2d = [fhatSPIRAL_c_2d];%fhatSPIRAL_p_2d;fhatSPIRAL_gp_2d];   
[X1,Y1,T1,AUC1] = perfcurve(f_c_true,f_c_spiral_3d,'1','XCrit', 'tpr', 'YCrit', 'prec');
[X2,Y2,T2,AUC2] = perfcurve(f_c_true,f_c_spiral_2d,'1','XCrit', 'tpr', 'YCrit', 'prec');
Y1(1)=1;
Y2(1)=1;
Y1(end)=0;
Y2(end)=0;
Area_recall_3d_c=trapz(-Y1,X1);
Area_recall_2d_c=trapz(-Y2,X2); 
acc_3d_c(z) = Area_recall_3d_c;%model_acurracy(f_true,f_spiral);             % accuracy 
acc_2d_c(z) = Area_recall_2d_c;%model_acurracy(f_true,f_spiral);             % accuracy 


%------------------

f_p_true = [f_p]; %; f_p; f_gp];  
f_p_spiral_3d = [fhatSPIRAL_p];%fhatSPIRAL_p;fhatSPIRAL_gp];  
f_p_spiral_2d = [fhatSPIRAL_p_2d];%fhatSPIRAL_p_2d;fhatSPIRAL_gp_2d];   
[X1,Y1,T1,AUC1] = perfcurve(f_p_true,f_p_spiral_3d,'1','XCrit', 'tpr', 'YCrit', 'prec');
[X2,Y2,T2,AUC2] = perfcurve(f_p_true,f_p_spiral_2d,'1','XCrit', 'tpr', 'YCrit', 'prec');
Y1(1)=1;
Y2(1)=1;
Y1(end)=0;
Y2(end)=0;
Area_recall_3d_p=trapz(-Y1,X1);
Area_recall_2d_p=trapz(-Y2,X2); 
acc_3d_p(z) = Area_recall_3d_p;%model_acurracy(f_true,f_spiral);             % accuracy 
acc_2d_p(z) = Area_recall_2d_p;%model_acurracy(f_true,f_spiral);             % accuracy 
%------------------

f_gp_true = [f_gp]; %; f_p; f_gp];  
f_gp_spiral_3d = [fhatSPIRAL_gp];%fhatSPIRAL_p;fhatSPIRAL_gp];  
f_gp_spiral_2d = [fhatSPIRAL_gp_2d];%fhatSPIRAL_p_2d;fhatSPIRAL_gp_2d];   
[X1,Y1,T1,AUC1] = perfcurve(f_gp_true,f_gp_spiral_3d,'1','XCrit', 'tpr', 'YCrit', 'prec');
[X2,Y2,T2,AUC2] = perfcurve(f_gp_true,f_gp_spiral_2d,'1','XCrit', 'tpr', 'YCrit', 'prec');
Y1(1)=1;
Y2(1)=1;
Y1(end)=0;
Y2(end)=0;
Area_recall_3d_gp=trapz(-Y1,X1);
Area_recall_2d_gp=trapz(-Y2,X2); 
acc_3d_gp(z) = Area_recall_3d_gp;%model_acurracy(f_true,f_spiral);             % accuracy 
acc_2d_gp(z) = Area_recall_2d_gp;%model_acurracy(f_true,f_spiral);             % accuracy 
end
%%
%%%% plot epsi vs accu %%%
close all
figure(1)
plot(p(1:22),acc_3d(1:22),"LineWidth",1,"Color","blue");hold on
plot(p,acc_2d,"LineWidth",1,"Color","red"); hold on 
scatter(p(1:22),acc_3d(1:22),'filled',"blue"); hold on
scatter(p,acc_2d,'filled',"red");
ylabel('$AUC_{pr}$','FontSize',30,Interpreter="latex");
xlabel('$p$','FontSize',30, Interpreter="latex");
...
figure(2)
subplot(3,1,1)
plot(p,acc_3d_c,"LineWidth",1,"Color","blue");hold on
plot(p,acc_2d_c,"LineWidth",1,"Color","red"); hold on 
scatter(p,acc_3d_c,'filled',"blue"); hold on
scatter(p,acc_2d_c,'filled',"red");
ylabel('$AUC_{pr}$','FontSize',20,Interpreter="latex");
...
subplot(3,1,2)
plot(p(1:20),acc_3d_p(1:20),"LineWidth",1,"Color","blue");hold on
plot(p,acc_2d_p,"LineWidth",1,"Color","red"); hold on 
scatter(p(1:20),acc_3d_p(1:20),'filled',"blue"); hold on
scatter(p,acc_2d_p,'filled',"red");
ylabel('$AUC_{pr}$','FontSize',20,Interpreter="latex");
xlabel('$p$','FontSize',20, Interpreter="latex");
legend("3D projections",'2D projections',"Location","best")
title("Parent Signal")
...
subplot(3,1,3)
plot(p(1:25),acc_3d_gp(1:25),"LineWidth",1,"Color","blue");hold on
plot(p,acc_2d_gp,"LineWidth",1,"Color","red"); hold on 
scatter(p(1:25),acc_3d_gp(1:25),'filled',"blue"); hold on
scatter(p,acc_2d_gp,'filled',"red");
ylabel('$AUC_{pr}$','FontSize',20,Interpreter="latex");
xlabel('$p$','FontSize',20, Interpreter="latex");
legend("3D projections",'2D projections',"Location","best")
