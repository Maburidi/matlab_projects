...
[X1,Y1] = perfcurve(f_true,f_spiral,'1','XCrit', 'tpr', 'YCrit', 'prec');
...
close all
figure(1)
plot(Alp(1:9),acc_3d(1:9),"LineWidth",1,"Color","blue");hold on
plot(Alp,acc_2d,"LineWidth",1,"Color","red"); hold on
scatter(Alp(1:9),acc_3d(1:9),'filled',"blue"); hold on
...
title("$\tau$ ="+ tau ,"Interpreter","latex","FontSize",20)
ylim([0.6 1])
