...
[X1,Y1,T1,AUC1] = perfcurve(f_true,f_spiral_3d,'1','XCrit', 'tpr', 'YCrit', 'prec');
...
str2 = strcat('AUC_{2D}= ',num2str(round(Area_recall_2d,3)));
...
thresh = th(i) ;
if j==1
f_gp_thresh_3d = f_gp_spiral >= thresh;
%f_thresh_2d = f_spiral_2d >= thresh;
subplot(3,3,k)
confusionchart(double(f_gp_true),double(f_gp_thresh_3d))
title(" Threshold =" + thresh )
ylabel("True GP Signal")
xlabel("3D-Predicted GP Signal")
elseif j==2
f_p_thresh_3d = f_p_spiral >= thresh;
%f_thresh_2d = f_spiral_2d >= thresh;
subplot(3,3,k)
confusionchart(double(f_p_true),double(f_p_thresh_3d))
title(" Threshold =" + thresh )
ylabel("True P Signal")
xlabel("3D-Predicted P Signal")
else 
f_c_thresh_3d = f_c_spiral >= thresh;
%f_thresh_2d = f_spiral_2d >= thresh;
subplot(3,3,k)
confusionchart(double(f_c_true),double(f_c_thresh_3d))
title(" Threshold =" + thresh )
ylabel("True C Signal")
xlabel("3D-Predicted C Signal")
end 
end 
end 
sgtitle("\lambda_{c} = " + 3 +",  \lambda_{p} = " + 3  ...
   + ",  \lambda_{gp} = " + 3 + ",  \epsilon =" + epsilon + ",   \beta =" ...
    + beta + ",   \tau =" + tau)
...
thresh = th(i) ;
if j==1
f_gp_thresh_2d = f_gp_spiral_2d >= thresh;
%f_thresh_2d = f_spiral_2d >= thresh;
subplot(3,3,k)
confusionchart(double(f_gp_true),double(f_gp_thresh_2d))
title(" Threshold =" + thresh )
ylabel("True GP Signal")
xlabel("2D-Predicted GP Signal")
elseif j==2
f_p_thresh_2d = f_p_spiral_2d >= thresh;
%f_thresh_2d = f_spiral_2d >= thresh;
subplot(3,3,k)
confusionchart(double(f_p_true),double(f_p_thresh_2d))
title(" Threshold =" + thresh )
ylabel("True P Signal")
xlabel("2D-Predicted P Signal")
else 
f_c_thresh_2d = f_c_spiral_2d >= thresh;
%f_thresh_2d = f_spiral_2d >= thresh;
subplot(3,3,k)
confusionchart(double(f_c_true),double(f_c_thresh_2d))
title(" Threshold =" + thresh )
ylabel("True C Signal")
xlabel("2D-Predicted C Signal")
end 
end 
end 
sgtitle("\lambda_{c} = " + 3 +",  \lambda_{p} = " + 3  ...
