...
%%
 finit_c= finit(1:n);
 finit_p = finit(n+1:2*n);
 finit_gp = finit(2*n+1:3*n);
...
scatter3(finit_c,finit_p,finit_gp,'filled');hold off;
...
%%
        [fhatSPIRAL_1gp1p1c, iterationsSPIRAL, objectiveSPIRAL,...
            reconerrorSPIRAL, cputimeSPIRAL, solutionpathSPIRAL_3d] ...
        ...
        [fhatSPIRAL_1gp1p1c_2, iterationsSPIRAL_2, objectiveSPIRAL_2,...
            reconerrorSPIRAL_2, cputimeSPIRAL_2,solutionpathSPIRAL_2d] ...
...
%%
close all 
inds_2d = [5 ;round((iterationsSPIRAL+3)/2) ;iterationsSPIRAL];
inds_3d = [5 ;round(iterationsSPIRAL/2) ;iterationsSPIRAL-2];

figure(2)
k=0;

for j=1:length(inds_3d) 
k=k+1;
midsol_c_2d= solutionpathSPIRAL_2d(inds_2d(j)).iterate(1:n);
midsol_p_2d = solutionpathSPIRAL_2d(inds_2d(j)).iterate(n+1:2*n);
midsol_gp_2d = solutionpathSPIRAL_2d(inds_2d(j)).iterate(2*n+1:3*n);

midsol_c_3d= solutionpathSPIRAL_3d(inds_2d(j)).iterate(1:n);
midsol_p_3d = solutionpathSPIRAL_3d(inds_2d(j)).iterate(n+1:2*n);
midsol_gp_3d = solutionpathSPIRAL_3d(inds_2d(j)).iterate(2*n+1:3*n);
...
plot3([0 0],[0 0],[1 0],LineWidth=3, Color="red"); hold on;
plot3([0 1],[1 1],[1 1], LineWidth=3, Color="red"); hold on;
scatter3(midsol_c_2d,midsol_p_2d,midsol_gp_2d,'filled');
xlabel('$C$','FontSize',10,Interpreter="latex");
ylabel('$P$','FontSize',10, Interpreter="latex");
zlabel('$GP$','FontSize',10, Interpreter="latex");
title("2D Solution at iteration =" + inds_2d(j))
k=k+1;
subplot(3,2,k)
corners = [0 0 0;0 1 1;0 0 1;1 1 1]; 
scatter3(corners(:,1),corners(:,2),corners(:,3),'.');hold on;
...
plot3([0 0],[0 0],[1 0],LineWidth=3, Color="red"); hold on;
plot3([0 1],[1 1],[1 1], LineWidth=3, Color="red"); hold on;
scatter3(midsol_c_3d,midsol_p_3d,midsol_gp_3d,'filled');
xlabel('$C$','FontSize',10,Interpreter="latex");
ylabel('$P$','FontSize',10, Interpreter="latex");
zlabel('$GP$','FontSize',10, Interpreter="latex");
title("3D Solution at iteration =" + inds_3d(j))
