...
thresh = th(i) ;
if j==1
f_thresh_3d = f_spiral_3d >= thresh;
f_thresh_2d = f_spiral_2d >= thresh;
subplot(1,3,k)
confusionchart(f_thresh_3d,f_thresh_2d)
...
% f_thresh_2d = f_spiral_2d >= thresh;
% subplot(3,3,k)
% confusionchart(double(f_true),double(f_thresh_2d))
% %title(" Threshold =" + thresh )
% xlabel("2D predictions")
% ylabel("True")
% else 
% f_thresh_3d = f_spiral_3d >= thresh;
% subplot(3,3,k)
% confusionchart(double(f_true),double(f_thresh_3d))
% %title(" Threshold =" + thresh )
% xlabel("3D predictions")
% ylabel("True")
% end 
% end 
% end 
