...
figure(2)
histogram(yy_0,'Normalization','pdf','FaceAlpha',0.2); hold on
histogram(yy_1,'Normalization','pdf','FaceAlpha',0.2); hold off 
legend("Zeros","Ones")
xlabel("Coverage")
title ("True Signal") 
...
%figure(5)
%cm = confusionchart(double(f_true),double(f_thresh))
...
%%%% plot epsi vs accu %%%
figure(1)
plot(Alp,acc,"LineWidth",1,"Color","blue");hold on
plot(Alp,acc_2d,"LineWidth",1,"Color","red"); hold on 
scatter(Alp,acc,'filled',"blue"); hold on
scatter(Alp,acc_2d,'filled',"red");
ylabel('$AUC_{pr}$','FontSize',30,Interpreter="latex");
xlabel('$\lambda_{p}$','FontSize',30, Interpreter="latex");
