...
%ind_p =find(y_p ==1);      
%ind_gp =find(y_gp ==1);   
%[ind_c_p,idx] = intersect(ind_c,ind_p,"stable"); 
%[ind_c_p_gp,idx1] = intersect(ind_c_p,ind_gp,"stable"); 
%y_c(ind_c_p_gp) = []; 
%y_p(ind_c_p_gp) = []; 
%y_gp(ind_c_p_gp) = []; 
...
plot(X1,Y1,'red','LineWidth',3) ;hold on;
plot(X2,Y2,'blue','LineWidth',3) ;hold on;
...
str1 = strcat('AUC_{2D}= ',num2str(round(Area_recall_3d,3)));
str2 = strcat('AUC_{3D}= ',num2str(round(Area_recall_2d,3)));
annotation('textbox',dim1,'String',str1,'FitBoxToText','on');
annotation('textbox',dim2,'String',str2,'FitBoxToText','on');
legend("2D Projections","3D Projections","Location","best")
title('All Signals')
...
Area_recall_2d=trapz(-Y2,X2); 
plot(X1,Y1,'red','LineWidth',3) ;hold on;
plot(X2,Y2,'blue','LineWidth',3,'LineStyle','--') ;hold on;
plot([0,1],[1,0],'r-.','LineWidth',1); hold off;   
xlabel('Recall')
ylabel('Precision')
dim1 = [.24 .3 .3 .1];
...
[FPRv_cpgp_2d,TPRv_cpgp_2d,PPV_cp_2d] = ROC_CURVE(f_spiral_2d, f_true, thresh);

%ROC_data = roc_curve(f_spiral, f_true, 1);
AUC = 1-trapz(1-TPRv_cpgp,FPRv_cpgp);
AUC_2d = 1-trapz(1-TPRv_cpgp_2d,FPRv_cpgp_2d);

%[recall,accuracy,precision] = metrics(f_true,f_spiral) ; 

figure(1)  
plot(FPRv_cpgp,TPRv_cpgp,'red','LineWidth',3); hold on;
plot(FPRv_cpgp_2d,TPRv_cpgp_2d,'blue','LineWidth',3); hold on;
...
dim1 = [.7 .3 .3 .1];
dim2 = [.7 .3 .3 .01];
str1 = strcat('AUC_{2D}= ',num2str(round(AUC,3)));
str2 = strcat('AUC_{3D}= ',num2str(round(AUC_2d,3)));
annotation('textbox',dim1,'String',str1,'FitBoxToText','on');
annotation('textbox',dim2,'String',str2,'FitBoxToText','on');
...
[FPRv_cpgp_2d,TPRv_cpgp_2d,PPV_cp_2d] = ROC_CURVE(f_c_spiral_2d, f_c_true, thresh);
...
[FPRv_cpgp_2d,TPRv_cpgp_2d,PPV_cp_2d] = ROC_CURVE(f_p_spiral_2d, f_p_true, thresh);
...
[FPRv_cpgp_2d,TPRv_cpgp_2d,PPV_cp_2d] = ROC_CURVE(f_gp_spiral_2d, f_gp_true, thresh);
